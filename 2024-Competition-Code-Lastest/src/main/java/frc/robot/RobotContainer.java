...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    JoystickButton resetHeadingButton = new JoystickButton(actualXbox, XboxController.Button.kX.value);
    resetHeadingButton.onTrue(swerve.resetHeadingCommand());
    JoystickButton resetPoseButton = new JoystickButton(actualXbox, XboxController.Button.kY.value);
    resetPoseButton.onTrue(swerve.resetPoseCommand());
  }
