  ...
  public SwerveAuto(String pathName, SwerveDrive swerve) {
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
            new PIDConstants(2.0, 0.0, 0.0), // Translation PID constants -> path independent
            new PIDConstants(4.0, 0.0, 0.0), // Rotation PID constants -> more or less path dependent
