package frc.robot.commands.auto.RedAlliance1;
...
public class R1_StartToSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
   ...
   */
  public R1_StartToSpeaker(String pathName, SwerveDrive swerve) {
    this.swerve = swerve;
