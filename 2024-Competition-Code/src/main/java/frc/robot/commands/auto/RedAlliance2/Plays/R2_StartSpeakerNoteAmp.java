...
public class R2_StartSpeakerNoteAmp extends SequentialCommandGroup {
  ...
  public R2_StartSpeakerNoteAmp(SwerveDrive swerve, Shooter shooter) {
    ...
    addCommands(
      ...
      new AutoPath("R2 Speaker to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new IntakeBeamBreak(-0.6, this.shooter), //Automatically stops
      new AutoPath("R2 Note to Amp", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
