...
public class R1_StartSpeakerNoteAmp extends SequentialCommandGroup {
  ...
  public R1_StartSpeakerNoteAmp(SwerveDrive swerve, Shooter shooter) {
    ...
    addCommands(
      ...
      new AutoPath("R1 Speaker to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new IntakeBeamBreak(-0.6, this.shooter), //Automatically stops
      new AutoPath("R1 Note to Amp", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
