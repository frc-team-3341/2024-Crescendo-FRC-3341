package frc.robot.commands.auto.BlueAlliance3;
...
public class B3_StartToSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
   ...
   */
  public B3_StartToSpeaker(String pathName, SwerveDrive swerve) {
    this.swerve = swerve;
...
//
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
            new PIDConstants(1, 0.0, 0.0), // Translation PID constants -> path independent
            new PIDConstants(1, 0.0, 0.0), // Rotation PID constants -> more or less path dependent
