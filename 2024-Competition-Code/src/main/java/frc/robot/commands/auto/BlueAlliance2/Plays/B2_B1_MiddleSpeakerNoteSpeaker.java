...
public class B2_B1_MiddleSpeakerNoteSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
  Shooter shooter;
  AutoPath autoPath;
  /** Creates a new B1_StartAmpNoteSpeaker. */
  public B2_B1_MiddleSpeakerNoteSpeaker(SwerveDrive swerve, Shooter shooter) {
    this.swerve = swerve;
    ...
    addCommands(
      ...
      new ParallelCommandGroup(new AutoPath("B1 Middle Speaker to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0), false),
      new IntakeBeamBreak(0.6, this.shooter).withTimeout(3)),
