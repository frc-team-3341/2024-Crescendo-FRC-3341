...
public class R1_StartSpeakerNote extends SequentialCommandGroup {
  SwerveDrive swerve;
  Shooter shooter;
  AutoPath autoPath;
  /** Creates a new B1_StartAmpNoteSpeaker. */
  public R1_StartSpeakerNote(SwerveDrive swerve, Shooter shooter) {
    this.swerve = swerve;
    ...
    addCommands(
      ...
      new AutoPath("R1 Speaker to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0), true),
