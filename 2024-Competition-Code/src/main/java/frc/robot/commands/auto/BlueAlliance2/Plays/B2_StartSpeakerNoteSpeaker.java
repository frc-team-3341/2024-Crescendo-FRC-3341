...
public class B2_StartSpeakerNoteSpeaker extends SequentialCommandGroup {
  ...
  public B2_StartSpeakerNoteSpeaker(SwerveDrive swerve, Shooter shooter) {
    ...
    addCommands(
      new AutoPath("B2 Start to Speaker", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new Shoot(3500, 3500, this.shooter),
      new AutoPath("B2 Amp to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new IntakeBeamBreak(-0.6, this.shooter),
      new AutoPath("B2 Note to Speaker", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new Shoot(3500, 3500, this.shooter)
    );
  }
}