package frc.robot.commands.auto.RedAlliance3;
...
public class R3_StartToSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
   ...
   */
  public R3_StartToSpeaker(String pathName, SwerveDrive swerve) {
    this.swerve = swerve;
