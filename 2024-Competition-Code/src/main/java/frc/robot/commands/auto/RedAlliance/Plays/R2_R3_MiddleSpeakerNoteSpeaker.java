...
public class R2_R3_MiddleSpeakerNoteSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
  Shooter shooter;
  AutoPath autoPath;
  /** Creates a new B1_StartAmpNoteSpeaker. */
  public R2_R3_MiddleSpeakerNoteSpeaker(SwerveDrive swerve, Shooter shooter) {
    this.swerve = swerve;
    ...
    addCommands(
      ...
      new AutoPath("R2 Note to Speaker Parallel", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0), false),
      new Shoot(3500,3500, this.shooter).withTimeout(3),
      new ParallelCommandGroup(new AutoPath("R3 Middle Speaker to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0), true),
      new IntakeBeamBreak(0.6, this.shooter).withTimeout(3)),
