package frc.robot.commands.auto.RedAlliance2;
...
public class R2_StartToSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
   ...
   */
  public R2_StartToSpeaker(String pathName, SwerveDrive swerve) {
    this.swerve = swerve;
