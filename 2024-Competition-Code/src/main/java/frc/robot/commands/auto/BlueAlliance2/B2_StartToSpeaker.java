package frc.robot.commands.auto.BlueAlliance2;
...
public class B2_StartToSpeaker extends SequentialCommandGroup {
  SwerveDrive swerve;
   ...
   */
  public B2_StartToSpeaker(String pathName, SwerveDrive swerve) {
    this.swerve = swerve;
