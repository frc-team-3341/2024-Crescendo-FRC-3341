...
public class B3_StartSpeakerNoteSpeaker extends SequentialCommandGroup {
  ...
  public B3_StartSpeakerNoteSpeaker(SwerveDrive swerve, Shooter shooter) {
    ...
    addCommands(
      new AutoPath("B3 Start to Speaker", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new Shoot(3500, 3500, this.shooter),
      new AutoPath("B3 Amp to Note", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new IntakeBeamBreak(-0.6, this.shooter),
      new AutoPath("B3 Note to Speaker", this.swerve, new PIDConstants(1.0, 0, 0), new PIDConstants(1.0, 0, 0)),
      new Shoot(3500, 3500, this.shooter)
    );
  }
}