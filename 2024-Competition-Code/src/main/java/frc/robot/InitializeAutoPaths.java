...
public class InitializeAutoPaths {
        ...
        public InitializeAutoPaths(SwerveDrive swerve, Shooter shooter) {
                ...
                B1_AmpToNote = new AutoPath("B1 Amp to Note", this.swerve, new PIDConstants(1.0, 0, 0),
                                new PIDConstants(1.0, 0, 0)); // Has to be the same name as the path name in the paths
                                                              // folder
                ...
                // Individual paths
                if (Constants.currentRobot.enableIndividualAutoPaths) {
                ...
                if (!Constants.currentRobot.enableIndividualAutoPaths) {
                        autoCommandChooser.setDefaultOption("B1_StartAmpNoteSpeaker", B1_StartAmpNoteSpeaker);
                }
